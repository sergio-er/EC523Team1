...
if __name__ == "__main__":
    ...
    test_loader = get_loader("/projectnb/ec523kb/projects/teams_Fall_2024/Team_1/Sergio/BulatDoubleGan/widerfacetest", batch_size=1)
    num_test = 10
    test_save = "/projectnb/ec523kb/projects/teams_Fall_2024/Team_1/Sergio/BulatDoubleGan/unpaired_face_sr/intermid_results"
    ...
    for ep in range(1, max_epoch+1):
        ...
        for i, batch in enumerate(loader):
            ...
            print(" {}({}) D_h2l: {:.3f}, D_l2h: {:.3f}, G_h2l: {:.3f}, G_l2h: {:.3f} \n".format(i+1, ep, loss_D_h2l.item(), loss_D_l2h.item(), loss_G_h2l.item(), loss_G_l2h.item()), end=" ")
        if(ep%20==0):
